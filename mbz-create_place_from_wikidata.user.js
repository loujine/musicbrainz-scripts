...
// @require      https://greasyfork.org/scripts/13747-mbz-loujine-common/code/mbz-loujine-common.js?version=169807
...
function fillForm(wikiId) {
    ...
    parseWD.setValue('id-edit-place.edit_note', sidebar.editNote(meta));
}
